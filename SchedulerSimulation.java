...
public class SchedulerSimulation {
    // Feature 2
    // Counts total number of context switches
    static int contextSwitchCount = 0;
    public static void main(String[] args) {
        // ⚠️ IMPORTANT: Put your student ID here to seed the random number generator
        // This makes your output unique to you - DO NOT forget to change this!
        int studentID = 445050295;  // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        for (int i = 1; i <= numProcesses; i++) {
            ...
            // Feature 1
            // Creating process with random priority
            Process process = new Process(name, burstTime, timeQuantum, priority);
